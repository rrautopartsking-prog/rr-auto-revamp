  ...
  return (
    <footer className="bg-carbon-950 border-t border-white/5">
      <div className="container mx-auto px-4 py-16">
        ...
        {/* Map Block — same style as contact page */}
        <div className="mt-12 rounded-2xl overflow-hidden border border-white/10">
          ...
          {/* Info strip — Shop / Phone / Email / Hours */}
          <div className="grid grid-cols-2 md:grid-cols-4 border-t border-white/10 bg-carbon-900">
            ...
            <div className="px-5 py-4">
              ...
              <p className="text-white text-sm leading-relaxed">Mon – Sat<br />9AM – 7PM IST</p>
            </div>
          </div>

          {/* Bottom bar */}
          <div className="flex items-center justify-between px-5 py-3 bg-carbon-900 border-t border-white/10">
            <a href={mapUrl} target="_blank" rel="noopener noreferrer"
              className="text-gold text-xs hover:underline">
              View larger map ↗
            </a>
            <a href={`https://wa.me/${whatsapp}`} target="_blank" rel="noopener noreferrer"
              className="flex items-center gap-1.5 text-[#25D366] text-xs hover:underline">
