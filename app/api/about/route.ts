...
export const defaultAboutData = {
  ...
  team: [
    {
      name: "Abhiyansh Arora",
      role: "Founder",
      bio: "The visionary behind RR Auto Revamp. Built the business from the ground up with a passion for genuine automotive parts and customer trust.",
      image: "",
      linkedin: "",
    },
    {
      name: "Jatin Arora",
      role: "Co-Founder",
      bio: "Drives operations and sourcing at RR Auto Revamp. Ensures every part meets quality standards and every customer gets the best deal.",
      image: "",
      linkedin: "",
    },
  ],
