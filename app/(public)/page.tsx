...
export const metadata: Metadata = {
  ...
  description:
    "Buy OEM, aftermarket & performance car spare parts in Delhi. Shop 1391, Ahata Banwari Lal, Nicholson Rd, Kashmere Gate. BMW, Mercedes, Audi, Maruti, Hyundai & more. Call +91 84481 76091.",
  keywords: [
  ...
  openGraph: {
    ...
    description: "OEM, aftermarket & performance car parts at Shop 1391, Ahata Banwari Lal, Nicholson Rd, Kashmere Gate, Delhi.",
...
export default async function HomePage() {
  ...
  const localBusinessJsonLd = {
    ...
    address: {
      "@type": "PostalAddress",
      streetAddress: "Shop 1391, Top Floor, Ahata Banwari Lal, Nicholson Rd",
